...
export const Header = (props) => {
  ...
  const [currencyState, setCurrencyState] = useState("BASE");
  ...
  async function switchToBASE() {
    ...
    await window.ethereum.request({
      ...
      params: [
        {
          chainId: "0x2329",
          rpcUrls: ["https://eth.bd.BASE.org:8545"],
          ...
          blockExplorerUrls: ["https://evm.BASE.org/"],
        },
      ],
    });
  ...
  async function sellUsingBASED() {
    setCurrencyState("BASED");
  }
                          ...
                          <table class="w-full text-xl text-left text-gray-500 dark:text-gray-400 border rounded-r-md">
                            ...
                            <tbody>
                              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="py-4 px-6">
                                  {contract.currency === "1" ? <div>{contract.price} BASED</div> : <div>{contract.price} USDC</div>}
                                </td>
                                <td class="py-4 px-6">
                      ...
                      <div class="mb-4">
                        ...
                        <div>
                          <ul class="grid grid-cols-2 float-left">
                            <span>
                              <input onClick={sellUsingBASED} class="sr-only peer" type="radio" value="BASED" name="answer" id="BASED" />
                              <label
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-8 col-md-offset-2 intro-text">
                  ...
                  {wrongNetwork === true ? (
                    <a className="btn btn-danger btn-lg" onClick={() => switchToBASED()}>
                      Wrong Network click here to connect to BASED
                    </a>
                  ) : (
                    <a className="btn btn-custom btn-lg" onClick={requireWallet}>
                      Connect Wallet to Start | BASED BLockchain
                    </a>
                  )}
                </div>
              </div>
